...
//to generate reports, we have to specify format, for test status extent test,for html spark, after test all should return html file 
...
//in case of failure it wont write
public class ExtentReportTest {
	...
	public void javaSearchTest() throws IOException {
		extentTest = reports.createTest("Jave Search Test");
